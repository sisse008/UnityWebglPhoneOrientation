var OrientationDetectorLib = {
    ...
    JS_OrientationDetectorLib_Lock_LandScapePrimary: function () {
   ...
   JS_OrientationDetectorLib_Lock_LandScapeSecondary: function () {
        _JS_OrientationDetectorLib_FullScreen();
        setTimeout(function () {
            window.screen.orientation.lock('landscape-secondary').then(function() {
                console.log('lock success');
                JS_OrientationDetectorLib_Context.isScreenLock = true;
            }).catch(function() {
                console.log('could not lock');
